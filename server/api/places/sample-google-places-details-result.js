// Sample Google Places Details Response Result
...
var data = {
  ...
  rating:                   place.rating,
  primary_photo:            place.photos[0].photoreference,
  opening_hours:            place.opening_hours.periods, // returns array of objects, see https://developers.google.com/places/webservice/details opening_hours for drilldown
  open_now?:                place.opening_hours.open_now,
  latitude:                 place.geometry.location.lat,
  longitude:                place.geometry.location.lng,
  business_website:         place.website,
  google_maps_url:          'https://www.google.com/maps/@' + place.geometry.location.lat + ',' + place.geometry.location.lng + ',16z'
};
